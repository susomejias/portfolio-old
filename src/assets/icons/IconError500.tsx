...
interface IconError500Props {
  width: string
  height: string
}

const IconError500 = (props: IconError500Props): JSX.Element => {
  return (
    <svg
      data-name="Layer 1"
    ...
    >
      ...
      />
      <path fill="#fbbd03" opacity={0.4} d="M271.609 150h16v16h-16z" />
      <path fill="#fbbd03" opacity={0.8} d="M294.609 150h16v16h-16z" />
      <path fill="#fbbd03" d="M317.609 150h16v16h-16z" />
      <path fill="#fbbd03" opacity={0.4} d="M271.609 251h16v16h-16z" />
      <path fill="#fbbd03" opacity={0.8} d="M294.609 251h16v16h-16z" />
      <path fill="#fbbd03" d="M317.609 251h16v16h-16z" />
      <path fill="#fbbd03" opacity={0.4} d="M271.609 352h16v16h-16z" />
      <path fill="#fbbd03" opacity={0.8} d="M294.609 352h16v16h-16z" />
      <path fill="#fbbd03" d="M317.609 352h16v16h-16z" />
